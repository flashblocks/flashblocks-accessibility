...
const { moveToAdvanced: MOVE_CONTROLS_TO_ADVANCED_PANEL, allowedBlocks } = window.flashblocksAccessibilitySettings || { moveToAdvanced: true, allowedBlocks: [] };

// Add the switch and a text field to a new "Accessibility" section
wp.hooks.addFilter(
	'blocks.registerBlockType',
	'flashblocks-accessibility/add-controls',
	(settings, name) => {
